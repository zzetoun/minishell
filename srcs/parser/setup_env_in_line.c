...
static size_t handle_single_quotes(char *line, size_t i, char **result)
{
    size_t start;
...
static size_t handle_env_variable(char *line, size_t i, char **result)
{
    size_t j;
...
static void append_char(char **result, const char c)
{
    char str[2] = {c, '\0'};
